...
export class AppSidebarComponent {
  ...
  navItems: NavItem[] = [
    ...
    //     icon:"<i class=\"fa-solid fa-puzzle-piece text-lg\"></i>",
    //     path: "/home/component-types",
    //   },
    //   {
    //     name: "Metadata Registry",
    //     icon: "<i class=\"fa-solid fa-database text-lg\"></i>",
    //     path: "/home/metadata-registry",
    //   },
    //   {
    //     name: "User Roles",
    //     icon: "<i class=\"fa-solid fa-user-gear text-lg\"></i>",
    //     path: "/home/roles",
    //   },
    //   {
    //     name: "Menu Groups",
    //     icon: "<i class=\"fa-solid fa-layer-group text-lg\"></i>",
    //     path: "/home/menu-groups",
    //   },
    //   {
    //     name: "Menus",
    //     icon: "<i class=\"fa-solid fa-bars text-lg\"></i>",
    //     path: "/home/menus",
    //   },
    //   {
    ...
    //     subItems: [
    //       { name: "Form Elements", path: "/home/form-elements", pro: false }
    //     ],
    //   },
    //   {
    //     name: "Tables",
    ...
    //     subItems: [
    //       { name: "Basic Tables", path: "/home/basic-tables", pro: false },
    //     ],
    //   },
    //   {
    //     name: "Pages",
  ...
  ngOnInit() {
    ...
    this.loadMenusForUser(userInfo?.user_id);
  }
  ...
  // To load menu as per user
  loadMenusForUser(user_id: number) {
    this.menusService.getMenuByUser(user_id).subscribe((data) => {
      this.menus = data?.menus ?? [];
      this.navItems = this.mapMenusToNavItems(this.menus);
      // Set active menu AFTER navItems is populated to avoid race condition
      this.setActiveMenuFromRoute(this.router.url);
      this.cdr.detectChanges();
    });
  }

  mapMenusToNavItems(menus: any[]): any[] {
    ...
    menus.forEach(menu => {
      ...
      if (group) {
        if (!grouped[group.menu_group_id]) {
          grouped[group.menu_group_id] = {
            name: group.name,
            icon: group.icon ? `<i class="${group.icon} text-lg"></i>` : null,
            subItems: []
          };
        }

        grouped[group.menu_group_id].subItems.push({
          name: menu.name,
          path: menu.path,
          icon: menu.icon ? `<i class="${menu.icon} text-lg"></i>` : null,
        });
      } else {
        navItems.push({
          name: menu.name,
